import React, { createContext, type MutableRefObject, type ReactNode, useCallback, useRef, useState } from "react";
import { type View } from "react-native";

import { type ImageBlurEffectProps } from "@/app/components/ImageBlur/imageBlurView";
...
export const ImageBlurContext = createContext<ImageBlurContextType | undefined>(undefined);

export const ImageBlurProvider = ({ children }: ImageBlurContextProps): JSX.Element => {
  const [blurElementRefList, setBlurElementRefList] = useState<ImageBlurElementRef[] | null>(null);
  ...
  const setBlurProps = useCallback((props: ImageBlurEffectProps | undefined) => {
